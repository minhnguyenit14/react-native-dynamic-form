...
export default class CustomInput extends PureComponent {
  ...
  render() {
    ...
    return (
      <View style={[styles.container, theme.input.containerStyle]}>
        <LabelError
          label={this.props.label}
          error={this.props.error}
        />
        <View style={[theme.input.inputContainerStyle,
        this.props.multiline && theme.input.multilineContainerStyle,
        (this.props.error || this.props.errorMessage) && {
          ...theme.input.inputContainerErrorStyle,
          ...theme.input.inputErrorStyle,
        }]}>
          <TextInput
        ...
        {
          !!this.props.errorMessage &&
          <Text style={[styles.error, theme.input.errorStyle]}>{this.props.errorMessage}</Text>
        }
      </View>
    );
  }
